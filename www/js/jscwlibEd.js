 ...
 * sub authour: Stephen monk
 * changed inline onclicks for listeners
 */
...
//                this.whiteNoise.start(0);
        ...
        this.play = function(playtext) {
          //console.log(this.inloop,'<<play()::',playtext);
            if (!this.init_done) {
                this.init();
            }
        ...
        this.stop = function() {
        //  console.log(this.mode,'<<stop()::',this);
      //  this.inloop = false;
            if (this.mode == 'audio') {
                this.gainNode.gain.cancelScheduledValues(this.audioCtx.currentTime);
                this.gainNode.gain.setValueAtTime(0, this.audioCtx.currentTime);
    ...
    //        }
        ...
        this.renderPlayer = function(el, obj) {
          ...
          /*  pb.style.width = '100%';//edit
            pb.style.height = '15px';
            pb.style.display = 'block';
            pb.style.backgroundColor = 'rgba(250,250,250,0.8)';*/
            pb.classList.add('morse_pb_progress')
            pb.id = "pb";
          ...
          /*  l.style.fontSize = "12px";
            ...
            l.style.display = "inline-block";//adition*/
            l.classList.add('morse_pb_label');
            obj.setProgressbar(pb, l);

            var btn_pp = document.createElement("img");
            btn_pp.src = play_svg;
          //  btn_pp.src = `<span class='material-icons noPull clearInputText'>play_arrow</span>`;
        ...
        /*    btn_pp.style.borderRadius = "3px";
          ...
          /*  btn_pp.onclick = function () {
            ...
            var loopPlay = (()=>{
              //loop play is standard
                setTimeout(()=>{
                //  console.log(this,'<<this::',this.inloop);
                  this.paused = false;
                  obj.play();
                },300);
            });
            btn_pp.addEventListener('hold',function(event){

              //this.inloop = true;
          //    console.log(this.inloop,'<<in hold listener!');
          ...
          /*  btn_stop.style.borderRadius = "3px";
            ...
            btn_stop.classList.add('morse_PP_Stop');
            btn_stop.title = "Stop";
          ...
          /*  btn_set_img.style.borderRadius = "3px";
            ...
            btn_set_img.classList.add('morse_PP_settings');
...
//
          ...
          /*  btn_set_img.onclick = function () {
            ...
            btn_set_img.addEventListener('click',function(){
              obj.toggle_settings();
            })
            obj.updateControls();
